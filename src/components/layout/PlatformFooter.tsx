...
export function PlatformFooter({ platform }: PlatformFooterProps) {
  const currentYear = new Date().getFullYear();

  const platformConfig = {
    gigwork: {
      name: 'Gig Work Platform',
      links: [
        { name: 'Find Work', href: '/employee/jobs' },
        { name: 'Post Jobs', href: '/employer/jobs' },
        { name: 'How It Works', href: '/help' },
        { name: 'Safety', href: '/help' },
      ]
    },
    marketplace: {
      ...
      links: [
        ...
        { name: 'Market Trends', href: '/materials/price-trends' },
      ]
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-neutral-400 mb-4 max-w-md">
              {platform === 'gigwork' 
                ...
                : 'Transparent construction material pricing for Rwanda\'s building industry.'
              }
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:support@cerka.rw" className="text-neutral-400 hover:text-white transition-colors">
                  Contact Us
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-neutral-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-neutral-400 text-sm">
            © {currentYear} Cerka. All rights reserved.
          </p>
          ...
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            ...
            <span className="text-sm text-neutral-400">Made in Rwanda 🇷🇼</span>
          </div>
        </div>
      </div>
    </footer>
